...
export class FlowerPiece extends Piece {
  spaces: number;
...
export class RosePiece extends FlowerPiece {
  constructor(props: PieceProps) {
    super(props);
...
export class JasminePiece extends FlowerPiece {
  constructor(props: PieceProps) {
    super(props);
...
export class ChrysanthemumPiece extends FlowerPiece {
  constructor(props: PieceProps) {
    super(props);
...
export class LilyPiece extends FlowerPiece {
  constructor(props: PieceProps) {
    super(props);
...
export class RhododendronPiece extends FlowerPiece {
  constructor(props: PieceProps) {
    super(props);
...
export class JadePiece extends FlowerPiece {
  constructor(props: PieceProps) {
    super(props);
